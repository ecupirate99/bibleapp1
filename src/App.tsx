          ...
          <main className="flex-1 container mx-auto px-4 py-8 max-w-3xl">
            <div className="text-center mb-12 relative">
              ...
              <div className="flex items-center justify-center mb-4">
                ...
                <h1 className={`text-4xl sm:text-5xl font-serif ${darkMode ? 'text-white' : 'text-gray-800'}`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mb-8">
              ...
              <p className={`text-sm mt-2 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                Remember to click 'Clear' before entering new verse(s).
              </p>
              ...
              <div className={`space-y-8 p-6 rounded-lg shadow-sm ${
                ...
                <div>
                  ...
                  <blockquote className={`pl-4 border-l-4 font-serif text-xl leading-relaxed ${
                    ...
                    {interpretation.verse} ({interpretation.translation})
                  </blockquote>
                </div>

                <div>
                  <h2 className={`text-2xl font-serif mb-3 font-bold ${
                    darkMode ? 'text-white' : 'text-gray-800'
                  }`}>Interpretation</h2>
